...
?>
<h3 class="myaccount-sub-title">Your Account Details</h3>
<?php
...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post" <?php do_action('woocommerce_edit_account_form_tag'); ?>>
	...
	<div class="row">
		<div class="col wide">
		<legend>
					<?php esc_html_e('Edit Your Details', 'woocommerce'); ?>
				</legend>
			<div class="row">
				<div class="col">
				...
				<div class="col">
					<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
						...
						<input type="text" class="woocommerce-Input woocommerce-Input--text input-text"
							...
							value="<?php echo esc_attr($user->display_name); ?>" /> <span><em class="underfont">
								<?php esc_html_e('Displayed name in the account section and in reviews', 'woocommerce'); ?>
							</em></span>
					</p>
				</div>
				<div class="col">
					...
					<div class="col">
						<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
							...
							<input type="password" class="woocommerce-Input woocommerce-Input--password input-text"
								...
								<span><em class="underfont">
								<?php esc_html_e('(leave blank to leave unchanged)', 'woocommerce'); ?>
							</em></span>
						</p>
					</div>
					<div class="col">
	...
	<div class="row save-button-style">
		<p>
			<?php wp_nonce_field('save_account_details', 'save-account-details-nonce'); ?>
			<button type="submit"
				class="woocommerce-Button button<?php echo esc_attr(wc_wp_theme_get_element_class_name('button') ? ' ' . wc_wp_theme_get_element_class_name('button') : ''); ?> button-color"
