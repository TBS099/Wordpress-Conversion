					...
					<form class="woocommerce-form woocommerce-form-login login" method="post">
						...
						<p class="form-row">
							...
							<button type="submit"
								...
								style="margin-left:35px;"><?php esc_html_e('Log in', 'woocommerce'); ?></button>
						</p>
						...
						<p>Not a member yet?<a href="" class="register-button">Register Here</a></p>
					</form>
				...
				<div class="registration-form" id="register">
					...
					<div>
						...
						<form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action('woocommerce_register_form_tag'); ?>>
							...
							<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
								<label for="reg_email" class="center-out">
							...
							<p class="woocommerce-form-row form-row">
								...
								<button type="submit"
									...
									name="register" value="<?php esc_attr_e('Register', 'woocommerce'); ?>" style="margin-left:35px;"><?php esc_html_e('Register', 'woocommerce'); ?></button>
							</p>

							<?php do_action('woocommerce_register_form_end'); ?>
							<p>Already a member?<a href="" class="login-button">Login Here</a></p>
						</form>
					</div>
				</div>
			</div>
