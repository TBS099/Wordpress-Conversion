					...
					<div class="row">
							<div class="col-lg-4 single-right-left ">
								...
								<div class="col-lg-8 single-right-left simpleCart_shelfItem">
									...
									<p><span class="item_price"><?php echo get_woocommerce_currency_symbol().get_post_meta(get_the_ID(), '_sale_price', true);?></span><br>
										<del><?php echo get_woocommerce_currency_symbol().get_post_meta(get_the_ID(), '_regular_price', true);?></del>
									</p>
									<div class="rating1">
										<ul class="stars">
